...
rcurl --data  "userid=https://profiles.google.com/114719444327647609228&password=96d7ff55d14e29fc19bba3312891bca6" http://localhost:8080/system/security/apilogin
...
rbpost 'http://localhost:8080/datasets/bathing-water?update&status=experimental'
...
rbpost 'http://localhost:8080/datasets/os?update&status=experimental'

rpost "@reg-def.ttl" http://localhost:8080/
rpost "@taxonomy.ttl" "http://localhost:8080/def?batch-managed&status=stable"
