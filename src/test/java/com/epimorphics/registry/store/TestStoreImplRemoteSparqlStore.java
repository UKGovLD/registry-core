...
public class TestStoreImplRemoteSparqlStore {
    ...
    @Before
    public void setup() {
        basestore = new RemoteSparqlStore();
        ((RemoteSparqlStore) basestore).setEndpoint("http://localhost:3030/ds/query");
        ((RemoteSparqlStore) basestore).setUpdateEndpoint("http://localhost:3030/ds/update");
        ((RemoteSparqlStore) basestore).setGraphEndpoint("http://localhost:3030/ds/data");
